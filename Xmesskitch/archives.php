<?php include __DIR__.'/header.php'; ?>
	<header id="header">
	<h1><?php echo plxDate::formatDate($plxShow->plxMotor->cible, $plxShow->lang('ARCHIVES').' #month #num_year(4)') ?></h1>
	<hr>
	<ul class="repertory menu breadcrumb">
			<li><a href="<?php $plxShow->racine() ?>"><?php $plxShow->lang('HOME'); ?></a></li>
			<li><?php $plxShow->lang('ARCHIVES') ?> / <span aria-current="page"><?php echo plxDate::formatDate($plxShow->plxMotor->cible, ' #month #num_year(4)') ?></span></li>
		</ul>
	</header>
	<main id="main">
	<section>
